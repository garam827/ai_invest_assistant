...
OHLCV_CACHE_DIR = str(ARTIFACT_DIR / "cache" / "prediction")
FEATURE_HISTORY_PATH = str(ARTIFACT_DIR / "datasets" / "feature_history.csv")
...
def build_feature_history(tickers: dict | None = None, force_refresh: bool = False) -> pd.DataFrame:
    ...
    os.makedirs(os.path.dirname(FEATURE_HISTORY_PATH), exist_ok=True)
