...
INDICATOR_TABLE = pd.DataFrame(
    [
        ...
        {
            "지표": "일목균형표 (Ichimoku Kinko Hyo)",
            "설명": "전환선(9일)·기준선(26일)·구름(선행스팬A·B, 26일 선행 투영)·후행스팬(26일 후행 종가)으로 추세의 방향과 강도를 보조적으로 참고하는 지표. 매수/매도 추천 코멘트에 '구름 대비 가격 위치'가 시그널과 일치하는지 참고용으로만 반영되며, 톰 바소 매매 규칙(Donchian/ATR)에 직접 쓰이진 않는 보조 참고 지표.",
        },
    ]
).set_index("지표")
